 ...
 * @license MIT
 **************************************************************************************************************/
public class CFWSpaceUserMap extends CFWObject {
	
	public static final String TABLE_NAME = "CFW_SPACES_USER_MAP";
	...
	public CFWSpaceUserMap() {
		initializeFields();
	}
	
	public CFWSpaceUserMap(ResultSet result) throws SQLException {
		initializeFields();
	...
	public CFWSpaceUserMap foreignKeySpace(Integer value) {
	...
	public CFWSpaceUserMap foreignKeyUser(Integer value) {
