 ...
 * @license MIT-License
 **************************************************************************************************************/
public class ParameterQuerySelectMultiple extends ParameterDefinition {

	public static final String UNIQUE_NAME = "Query Select Multiple";
	...
	public String descriptionShort() {
		return "Parameter that uses values from a query result to create a multi select field.";
	}
