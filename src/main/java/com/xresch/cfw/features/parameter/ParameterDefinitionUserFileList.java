...
public class ParameterDefinitionUserFileList extends ParameterDefinition {

	public static final String LABEL = "User File List";
	...
	public String descriptionShort() {
		return "Allows the user to select from a list of files he has access to.";
	}
	...
	public CFWField getFieldForSettings(HttpServletRequest request, String dashboardid, Object fieldValue) {
		...
		CFWField settingsField = CFWField.newString(FormFieldType.SELECT, "userFileOptions")
						.allowHTML(true)
						.setOptions( CFWDBStoredFile.getUsersAccessibleFilesAsOptionsMap() )
						;
