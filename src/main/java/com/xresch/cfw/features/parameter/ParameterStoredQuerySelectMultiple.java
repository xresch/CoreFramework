 ...
 * @license MIT-License
 **************************************************************************************************************/
public class ParameterStoredQuerySelectMultiple extends ParameterDefinition {

	public static final String UNIQUE_NAME = "Stored Query Select Multiple";
	...
	public String descriptionShort() {
		return "Parameter that uses values from a stored query result to create a multi select field.";
	}
	...
	public CFWField getFieldForWidget(
		...
		CFWField settingsField = 
				CFWField.newTagsSelector("JSON_"+CFWParameterFields.VALUE)
