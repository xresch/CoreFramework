 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryCommandAggregate extends CFWQueryCommand {
	
	public static final String COMMAND_NAME = "aggregate";
	...
	private ArrayList<EnhancedJsonObject> recordsArray = new ArrayList<>();

	
	/***********************************************************************************************
	 * 
	 ***********************************************************************************************/
	public CFWQueryCommandAggregate(CFWQuery parent) {
		super(parent);
	}
	...
	public void initializeAction() throws Exception{
		...
		this.fieldnameAddAll(detectedFieldnames);
	}
	...
	public void execute(PipelineActionContext context) throws Exception {
		...
		if(isPreviousDone()) {
			for(EnhancedJsonObject record : recordsArray) {
				AggregationGroup group = groupMap.get(record.getMetadata("groupID"));
				group.addToRecord(record);
				outQueue.add(record);
			}
