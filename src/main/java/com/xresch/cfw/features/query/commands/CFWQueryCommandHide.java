 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryCommandHide extends CFWQueryCommand {
	
	private static final String COMMAND_NAME = "hide";

	private static final Logger logger = CFWLog.getLogger(CFWQueryCommandHide.class.getName());
	 ...
	 * 
	 ***********************************************************************************************/
	public CFWQueryCommandHide(CFWQuery parent) {
		super(parent);
	}
	...
	public String descriptionShort() {
		return "Hides the specified fields from the UI but keeps the data(e.g. for export).";
	}
	...
	public String descriptionSyntaxDetailsHTML() {
		return "<p><b>fieldname:&nbsp;</b> Names of the fields that should be hidden.</p>";
	}
