...
public class CFWQueryFunctionCeil extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "ceil";

	public CFWQueryFunctionCeil(CFWQueryContext context) {
		super(context);
	}
	...
	public String descriptionShort() {
		return "Returns the number rounded up to the next integer.";
	}
	...
	public String descriptionSyntaxDetailsHTML() {
		return 
			 "<ul>"
			+"<li><b>number:&nbsp;</b>The value that should be rounded.</li>"
			+"</ul>"
			;
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters) {
		...
		if(initialValue.isNumberOrNumberString()) {
			...
			return QueryPartValue.newNumber(
					initialValue.getAsBigDecimal().setScale(0, RoundingMode.CEILING)
				);
		}
