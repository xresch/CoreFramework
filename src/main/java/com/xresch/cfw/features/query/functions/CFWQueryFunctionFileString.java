 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryFunctionFileString extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "fileString";

	public CFWQueryFunctionFileString(CFWQueryContext context) {
		super(context);
	}
	...
	public String descriptionShort() {
		return "Returns the contents of a file stored in the file manager as a string.";
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters, ArrayList<QueryPart> unevalParams) {
		...
		return QueryPartValue.newString( dataString );
