...
public class CFWQueryCommandDisplayFields extends CFWQueryCommand {
	...
	public String descriptionSyntax() {
		return COMMAND_NAME+" fields=<fields> "+CFWQueryCommandDisplay.DESCIRPTION_SYNTAX;
	}
					...
					.replace(
							...
							, """
							  <ul>
							  	...
							  	<li><b>widht:&nbsp;</b>(Optional) CSS width attribute to control the size of the display.</li>
							  """
					)
				;
	}
