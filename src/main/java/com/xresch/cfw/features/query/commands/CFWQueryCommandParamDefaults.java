...
public class CFWQueryCommandParamDefaults extends CFWQueryCommand {
	 ...
	 * 
	 ***********************************************************************************************/
	public CFWQueryCommandParamDefaults(CFWQuery parent) {
		super(parent);
	...
	public String descriptionShort() {
		return "Sets default values for parameters, which are shared globally.";
	}
	...
	public String descriptionSyntax() {
		return COMMAND_NAME+" <name>=<value> [, <name>=<value> ...]";
	}
	...
	public String descriptionSyntaxDetailsHTML() {
		return "<p><b>name:&nbsp;</b>The name of the parameter.</p>"
			  +"<p><b>value:&nbsp;</b>The value of the parameter.</p>"
				;
	}
	...
	public void initializeAction() throws Exception {
		...
		JsonObject parametersObject = this.getParent().getContext().getParameters();
		...
		for(QueryPartAssignment assignment : assignmentParts) {
			...
			if(!parametersObject.has(propertyName)) {
				valuePart.addToJsonObject(propertyName, parametersObject);
			}
