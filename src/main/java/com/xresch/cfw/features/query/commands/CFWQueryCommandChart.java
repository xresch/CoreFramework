...
public class CFWQueryCommandChart extends CFWQueryCommand {
	...
	+"<p><b>thresholds:&nbsp;</b>Allows you to define an array of threshold definitions like [ [minValue, maxValue, color, label], ...].</p>"	
	...
	+"<p><b>multichartby:&nbsp;</b>Allows to define by what fields the multicharts should be split.</p>"	
