 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryFunctionIsNull extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "isnull";

	public CFWQueryFunctionIsNull(CFWQueryContext context) {
		super(context);
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters) {
		...
		if(parameters.size() >= 1) { 
			...
			return QueryPartValue.newBoolean( value.isNull() );
		}
