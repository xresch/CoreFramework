 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryCommandMovStdev extends CFWQueryCommand {
	
	private static final String COMMAND_NAME = "movstdev";
	 ...
	 * 
	 ***********************************************************************************************/
	public CFWQueryCommandMovStdev(CFWQuery parent) {
		super(parent);
	}
	...
	public String descriptionShort() {
		return "Calculates a moving standard deviation for the values of a field.";
	}
	...
	public void initializeAction() throws Exception {
		...
		for(QueryPartAssignment assignment : assignmentParts) {
			...
			if(assignmentName != null) {
				...
				else if	 (assignmentName.equals("population")) {	population = assignmentValue.getAsBoolean(); }
		...
		if(name == null) { name = "stdev"+period;}
		if(population == null) { population = false;}
