 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryFunctionIsObject extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "isobject";

	public CFWQueryFunctionIsObject(CFWQueryContext context) {
		super(context);
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters) {
		...
		if(parameters.size() >= 1) { 
			...
			return QueryPartValue.newBoolean( value.isJsonObject() );
		}
