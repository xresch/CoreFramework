 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryFunctionIsString extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "isstring";

	public CFWQueryFunctionIsString(CFWQueryContext context) {
		super(context);
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters) {
		...
		if(parameters.size() >= 1) { 
			...
			return QueryPartValue.newBoolean( value.isString() );
		}
