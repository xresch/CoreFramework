 ...
 * @license MIT-License
 ************************************************************************************************************/
public class CFWQueryFunctionFileCSV extends CFWQueryFunction {

	
	public static final String FUNCTION_NAME = "fileCSV";

	public CFWQueryFunctionFileCSV(CFWQueryContext context) {
		super(context);
	}
	...
	public String descriptionSyntax() {
		return FUNCTION_NAME+"(fileID, separator)";
	}
	...
	public String descriptionShort() {
		return "Returns the contents of a CSV file stored in the file manager.";
	}
	...
	public String descriptionSyntaxDetailsHTML() {
		return "<ul>"
			  ...
			  +"<li><b>separator:&nbsp;</b>The separator used in the CSV file. (default: ',')</li>"
			  +"</ul>"
			;
	}
	...
	public QueryPartValue execute(EnhancedJsonObject object, ArrayList<QueryPartValue> parameters, ArrayList<QueryPart> unevalParams) {
		...
		//------------------------------------
		// Read as JSON
		String csvString = CFW.DB.StoredFile.retrieveDataAsString(file);
