...
import com.xresch.cfw.features.query.commands.CFWQueryCommandRenameUseFirst;
...
import com.xresch.cfw.features.query.commands.CFWQueryCommandTopN;
...
import com.xresch.cfw.features.query.sources.CFWQuerySourceFile;
...
public class FeatureQuery extends CFWAppFeature {
	...
	public void register() {
		...
		CFW.Registry.Query.registerCommand(new CFWQueryCommandRenameUseFirst(null));
		...
		CFW.Registry.Query.registerCommand(new CFWQueryCommandTopN(null));
		...
		CFW.Registry.Query.registerFunction(new CFWQueryFunctionDistinctStream(null));
		...
		CFW.Registry.Query.registerFunction(new CFWQueryFunctionFileExcel(null));
		CFW.Registry.Query.registerFunction(new CFWQueryFunctionFileJson(null));
		CFW.Registry.Query.registerFunction(new CFWQueryFunctionFileString(null));
		...
		CFW.Registry.Query.registerFunction(new CFWQueryFunctionObjectLookup(null));
		...
		CFW.Registry.Query.registerSource(new CFWQuerySourceFile(null));
