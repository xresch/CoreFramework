...
public class CFWCredentialsEditorsMap extends CFWObject {
	...
	private CFWField<Integer> foreignKeyUser = CFWField.newInteger(FormFieldType.HIDDEN, CFWCredentialsEditorsMapFields.FK_ID_USER)
	...
	public CFWCredentialsEditorsMap() {
		initializeFields();
	}
	
	public CFWCredentialsEditorsMap(ResultSet result) throws SQLException {
		initializeFields();
	...
	public CFWCredentialsEditorsMap foreignCredentials(Integer value) {
	...
	public CFWCredentialsEditorsMap foreignKeyUser(Integer value) {
