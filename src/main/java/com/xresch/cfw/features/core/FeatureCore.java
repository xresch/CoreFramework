...
public class FeatureCore extends CFWAppFeature {
	...
	public void register() {
		...
		CFW.Registry.Components.addGlobalJavascript(HANDLE_JAR, FeatureCore.RESOURCE_PACKAGE + ".js", "chartjs-plugin-datalabels.min.js"); 
...
//		}
	...
	public void addFeature(CFWApplicationExecutor app) {	
		...
		app.addUnsecureServlet(ServletRandom.class, 		"/cfw/random");
