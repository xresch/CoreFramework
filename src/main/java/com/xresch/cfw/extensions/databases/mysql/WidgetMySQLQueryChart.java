...
public class WidgetMySQLQueryChart extends WidgetBaseSQLQueryChart {
	...
	public DBInterface getDatabaseInterface(String environmentID) {
		...
		if(environmentID != null) {
			...
			CFW.Messages.addWarningMessage("MySQL Query Chart: The chosen environment seems not configured correctly.");
			return null;
		}
	...
	public ArrayList<FileDefinition> getJavascriptFiles() {
		...
		array.add( new FileDefinition(HandlingType.JAR_RESOURCE, FeatureDBExtensionsMySQL.PACKAGE_RESOURCE, "emp_widget_mysqlquerychart.js") );
		return array;
	}
