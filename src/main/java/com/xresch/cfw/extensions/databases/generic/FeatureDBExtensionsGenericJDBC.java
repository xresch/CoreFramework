 ...
 * @license MIT-License
 **************************************************************************************************************/
public class FeatureDBExtensionsGenericJDBC extends CFWAppFeature {
	
	public static final String PACKAGE_RESOURCE = "com.xresch.cfw.extensions.databases.generic.resources";
	...
	public String getNameForFeatureManagement() {
		return "DB Extensions: Generic JDBC";
	};
